    ...
    public function getActivemember($class_code){
        ...
        if(!empty($client_list)) {
            ...
            foreach($client_list as $client_class_id => $client_class_info) {
                ...
                $uid_list[$client_class_info['client_account']] = $client_class_info['client_account'];
        ...
        $active_member_list = $mActive->getActiveByClientAccount($uid_list, 'value desc' , 0, 10);
        $active_list = array();
