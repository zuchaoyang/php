...
Message.prototype.pullmsg = function() {
	...
	this.socket.on('get_msg', function (data){
		...
		!!data.req ? $("#req_num").html("(" + data.req + "新)") : data.req = 0;
		...
		!!data.res ? $("#res_num").html("(" + data.res + "新)") : data.res = 0;
...
Message.prototype.show_message=function(){
	...
	var homework_num = !!$("#homework_num").html() && self.is_pull_homework ? $("#show_msg_load_main").append('<p><span>' + $("#homework_num").html().replace(/[^0-9]/ig, "") + '条</span>班级作业<a href="/Sns/ClassHomework/Published/index/class_code/' + class_code +'" class="f_orange" id="homework">查看</a></p>') : 0;
	var exam_num = !!$("#exam_num").html() && self.is_pull_exam ? $("#show_msg_load_main").append('<p><span>' + $("#exam_num").html().replace(/[^0-9]/ig, "")  + '条</span>班级考试<a href="/Sns/ClassExam/Exam/index/class_code/' + class_code +'" class="f_orange" id="exam">查看</a></p>') : 0;
	var req_num = !!$("#req_num").html() ? $("#show_msg_load_main").append('<p><span>' + $("#req_num").html().replace(/[^0-9]/ig, "")  + '条</span>好友请求<a href="/Sns/Friend/Manage/friend_request" class="f_orange" id="req">查看</a></p>') : 0;
	var res_num = !!$("#res_num").html() ? $("#show_msg_load_main").append('<p><span>' + $("#res_num").html().replace(/[^0-9]/ig, "")  + '条</span>好友回复<a href="#" class="f_orange" id="res">查看</a></p>') : 0;
	var comments_num = !!$("#comments_num").html() && self.is_pull_comments ? $("#show_msg_load_main").append('<p><span>' + $("#comments_num").html().replace(/[^0-9]/ig, "")  + '条</span>评论<a href="#" class="f_orange" id="comments">查看</a></p>') : 0;
	var notice_num = !!$("#notice_num").html() && self.is_pull_notice ? $("#show_msg_load_main").append('<p><span>' + $("#notice_num").html().replace(/[^0-9]/ig, "")  + '条</span>班级公告<a href="/Sns/ClassNotice/Published/index/class_code/' + class_code +'" id="notice" class="f_orange" id="notice">查看</a></p>') : 0;
	var private_num = !!$("#privatemsg_num").html() ? $("#show_msg_load_main").append('<p><span>' + $("#privatemsg_num").html().replace(/[^0-9]/ig, "")  + '条</span>私信<a href="/Sns/PrivateMsg/PrivateMsg/index" class="f_orange" id="privatemsg">查看</a></p>') : 0;
